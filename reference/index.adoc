...
:nodejs: link:https://nodejs.org[Node.js^]
:springroo: link:https://projects.spring.io/spring-roo[Spring Roo^]
:docker: link:https://www.docker.com[Docker^]
:stackoverflow: link:https://stackoverflow.com/questions/tagged/yaktor[Stack Overflow^]
:spring: link:https://spring.io[Spring^]
:npm: link:https://npmjs.org[npm^]
:mongodb: link:https://www.mongodb.com[MongoDB^]
:cassandra: link:https://cassandra.apache.org[Cassandra^]
:eclipseplugin: link:https://eclipse.yaktor.io[eclipse plugin^]
:javascript: link:https://www.ecma-international.org/publications/standards/Ecma-262.htm[JavaScript^]
:express: link:https://expressjs.com[Express^]
:mongoose: link:http://mongoosejs.com/[Mongoose^]
:springboot: link:https://spring.io/projects/spring-boot[Spring Boot^]
:akka: link:http://akka.io[Akka^]
:scala: link:https://www.scala-lang.org[Scala^]
:java: link:https://www.java.com[Java^]
...
or on the Yaktor docs site at https://docs.yaktor.io.
...
$ curl https://init.yaktor.io \| sh  <2>
...
$ mkdir myapp                                   <1>
$ cd myapp                                      <2>
$ curl https://init.yaktor.io \| sh              <3>
